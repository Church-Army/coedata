...
churches <- churches[c("Church_Nam", "Church_Cod", "ParLocNa", "ParishID", "BenefNa", "BenefID",
                       "DeanNa", "DeanID", "ArchdNa", "ArchdID", "DioNa", "DioID", "ACNY_ID", "ACNY_url")]

names(churches) <- c("church_name", "church_code", "parish_name", "parish_code", "benefice_name", "benefice_id",
                     "deanery_name", "deanery_id", "archdeaconry_name", "archdeaconry_id", "diocese_name",
                     "diocese_number", "acny_id", "acny_url")
...
esri_churches <- function(where, outFields){
  ...
  httr2::req_url_path("KDRjxGRQDVgVtFTS/ArcGIS/rest/services/Churches_June2025/FeatureServer/0/query") |> 
