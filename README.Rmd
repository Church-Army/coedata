...
For more information on getting census data, see `vignette("CoE Census Statistics")`.
...
For more information on getting deprivation data, see `vignette("Parish-level deprivation data")`
